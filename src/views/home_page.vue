...
<template>
    <div class="homepage">
      <header class="settings-header">
        <div class="horizontal header">
          ...
          <div class="horizontal settings">
            <a @click="removeAllClicked"class="clicable red">all off</a>
            <a @click="activeAllClicked"class="clicable green">all on</a>
          ...
          <div class="horizontal range-bar-example">
            <div class="horizontal range-bar">
              <span>Max letter:</span>
            ...
            <span id="exemple" class="letter_exemple"> in game: {{ letter_exemple }}</span>
          </div>
        <div class="horizontal cooldown">
        
          <span>Countdown per round: </span>
          <div class="horizontal cooldown_choice">
            <a @click="change_cooldown($event)" class="clicable time">none</a>
            <a @click="change_cooldown($event)" class="clicable time">5s</a>
            <a @click="change_cooldown($event)" class="clicable time">10s</a>
            <a @click="change_cooldown($event)" class="clicable time">15s</a>
      ...
      <div class="title">
          ...
          <h1><span class="title-text" id="carousel">A<span style="color: #4D764B;">l</span>p<span style="color: #744b76;">h</span>a<span style="color: #4D764B;">b</span>e<span style="color: #cc334c;">t</span>.</span><span id="cursor"class="input-cursor"></span></h1>
...
export default{
  ...
  methods:{
    ...
    change_cooldown(event){
      const clickables = document.querySelectorAll('.time');
      clickables.forEach(element => {
        element.classList.remove('clicked');
      })
      event.target.classList.add('clicked');
      this.cooldown = event.target.textContent;
    ...
    changeLocalValue(){
      ...
      let alp = Number(this.input_value) + 1
      this.letter_exemple = this.alphabet.slice(0,alp++)
      const text = document.getElementById('exemple');
